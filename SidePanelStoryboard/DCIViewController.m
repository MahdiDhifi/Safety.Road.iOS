...
- (void)viewDidLoad {
    ...
    switch (_i) {
        case 0:
            _drap.image=[UIImage imageNamed:@"dtunisie.png"];
            _city.text=@"Tunisia";
            _p.text=@"197";
            _h.text=@"190";
            _f.text=@"198";
            break;
        case 1:
            _drap.image=[UIImage imageNamed:@"daustria.png"];
            _city.text=@"Austria";
            _p.text=@"133";
            _h.text=@"144";
            _f.text=@"122";
            break;
        case 2:
            _drap.image=[UIImage imageNamed:@"dengland.png"];
            ...
            break;
        case 3:
            _drap.image=[UIImage imageNamed:@"degypt.png"];
            _city.text=@"Egypt";
            _p.text=@"122";
            _h.text=@"123";
            _f.text=@"180";
        ...
        case 4:
            _drap.image=[UIImage imageNamed:@"dfrance.png"];
            _city.text=@"France";
            _p.text=@"17";
            _h.text=@"18";
            _f.text=@"15";
        ...
        case 5:
            _drap.image=[UIImage imageNamed:@"dindia.png"];
            _city.text=@"India";
            _p.text=@"100";
            _h.text=@"102";
            _f.text=@"101";
        ...
        case 6:
            _drap.image=[UIImage imageNamed:@"ditaly.png"];
            _city.text=@"Italy";
            _p.text=@"113";
            _h.text=@"118";
            _f.text=@"115";
            break;
        case 7:
            _drap.image=[UIImage imageNamed:@"dgermany.png"];
            _city.text=@"Germany";
            _p.text=@"110";
            _h.text=@"112";
            _f.text=@"112";
        ...
        case 8:
            _drap.image=[UIImage imageNamed:@"dspain.png"];
            _city.text=@"Spain";
            _p.text=@"091";
            _h.text=@"061";
            _f.text=@"080";
